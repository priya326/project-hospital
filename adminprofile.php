...
if(isset($_POST[submit]))
{
	...
	{
		$sql ="UPDATE admin SET adminname='$_POST[adminname]',loginid='$_POST[loginid]',email='$_POST[email]',status='$_POST[select]' WHERE adminid='$_SESSION[adminid]'";
	...
	{
		$sql ="INSERT INTO admin(adminname,loginid,email,status) values('$_POST[adminname]','$_POST[loginid]','$_POST[email]','$_POST[select]')";
		if($qsql = mysqli_query($con,$sql))
		{
			echo "<div class='alert alert-success'>

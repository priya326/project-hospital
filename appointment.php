...
$sqlpat= "SELECT * FROM patient WHERE patientid='$_POST[select4]'";
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input required class="form-control" type="date" name="appointmentdate" min="<?php echo date("Y-m-d");?>"
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input required class="form-control no-resize" name="appreason" placeholder="Appointment Message*"
                            ...
                            <div class="col-sm-4 ">
                                <div class="form-group drop-custum">
                                    <select required name="select" id="select" class=" form-control show-tick">

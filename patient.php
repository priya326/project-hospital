...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="INSERT INTO patient(patientname,address,mobileno,city,pincode,loginid,email,password,bloodgroup,gender,dob,status) values('$_POST[patientname]','$_POST[address]','$_POST[mobilenumber]','$_POST[city]','$_POST[pincode]','$_POST[loginid]','$_POST[email]','$_POST[password]','$_POST[select2]','$_POST[select3]','$_POST[dateofbirth]','Active')";
		if($qsql = mysqli_query($con,$sql))
		{

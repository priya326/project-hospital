...
if(isset($_POST[submit]))
{
	...
	{
			$sql ="UPDATE doctor SET doctorname='$_POST[doctorname]',mobileno='$_POST[mobilenumber]',departmentid='$_POST[select3]',loginid='$_POST[loginid]',email='$_POST[email]',password='$_POST[password]',status='$_POST[select]',education='$_POST[education]',experience='$_POST[experience]',consultancy_charge='$_POST[consultancy_charge]' WHERE doctorid='$_GET[editid]'";
	...
	{
	$sql ="INSERT INTO doctor(doctorname,mobileno,departmentid,loginid,password,status,education,experience,email,,consultancy_charge) values('$_POST[doctorname]','$_POST[mobilenumber]','$_POST[select3]','$_POST[loginid]','$_POST[password]','Active','$_POST[education]','$_POST[experience]','$_POST[email]','$_POST[consultancy_charge]')";
	if($qsql = mysqli_query($con,$sql))
	{
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				...
				<div class="form-group"><label>Email</label> 
					<div class="form-line">
					<input class="form-control" type="text" name="email" id="email" value="<?php echo $rsedit[email]; ?>"/>
				</div>
				</div>

...
if(isset($_POST[submit]))
{
	...
	{
		$sql ="UPDATE doctor SET doctorname='$_POST[doctorname]',mobileno='$_POST[mobilenumber]',departmentid='$_POST[select3]',loginid='$_POST[loginid]',education='$_POST[education]',experience='$_POST[experience]',email='$_POST[email]',consultancy_charge='$_POST[consultancy_charge]' WHERE doctorid='$_SESSION[doctorid]'";
	...
	{
		$sql ="INSERT INTO doctor(doctorname,mobileno,departmentid,loginid,password,status,education,email,experience) values('$_POST[doctorname]','$_POST[mobilenumber]','$_POST[select3]','$_POST[loginid]','$_POST[password]','$_POST[select]','$_POST[education]',email='$_POST[email],'$_POST[experience]')";
		if($qsql = mysqli_query($con,$sql))
		{

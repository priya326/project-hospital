...
<body class="theme-cyan">
    ...
    <nav class="navbar clearHeader">
        <div class="col-12">
            <div class="navbar-header" style="text-shadow: 0px 0px 8px white; letter-spacing: 13px;"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand"
                    href="#">HEALING</a> </div>
                ...
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            ...
                            <li><a href="viewappointmentapproved.php">View Appointments</a></li>
                        </ul>
                    </li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-calendar-check"></i><span>Appointment</span> </a>
                        <ul class="ml-menu">
                            <li><a href="appointment2.php" >Add Appointment</a></li>
